...
public class AtualizarUsuario extends JFrame {
	 ...
	 * @throws SQLException 
	 */
	public AtualizarUsuario() throws SQLException, IOException {
		super("Reserva");
		usuarioController = new UsuarioController();
		setIconImage(Toolkit.getDefaultToolkit().getImage(AtualizarUsuario.class.getResource("/imagenes/aH-40px.png")));
		...
		JLabel lblTitulo = new JLabel("ATUALIZAÇÃO DE USUARIO");
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(AtualizarUsuario.class.getResource("/imagenes/aH-150px.png")));
